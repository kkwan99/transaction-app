        ...
        while (run) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    // filterTransactions()에서 byType.test(t) 가 수행된다 (이해 안되면 바로위에 byType이 호출돼서 filter를 시작한다라고 생각해라).
                ...
                case 4:
                    ...
                    sc.nextLine();
                    Function<Transaction, Double> discountFunc = tran
                            -> tran.getAmount() * (1 - (discountPercent * 100.0));
